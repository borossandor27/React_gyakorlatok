...
A leggyakrabban adatlekérésre használjuk a `useEffect`-et. A példában az ingyenes `https://restcountries.com/v3.1/alpha/{code}` API-ból kapott nestedJSON adataiból jelenítünk meg néhányat.
